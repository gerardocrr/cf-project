...
export function Sidebar() {
  const { user, isAuthorized } = useLoginStore.getState();
    ...
    <div>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <span className="p-2 self-center text-xl font-semibold whitespace-nowrap dark:text-white">
            {user}
          </span>
          <ul className="mt-5 space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="ms-3">Search cocktail</span>
              </Link>
            </li>
            {isAuthorized && (
              <li>
